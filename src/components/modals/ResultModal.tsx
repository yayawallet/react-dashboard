...
const ResultModal = ({ openModal, onCloseModal, successMessage }: Props) => {
  return (
    <div
      id="popup-modal"
      className={`bg-black/60 backdrop-blur-[0.4px] overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-full cursor-not-allowed ${openModal ? 'flex' : 'hidden'}`}
    >
