                    ...
                    {reportList.map((list: ReportType) => (
                      <tr key={list.uuid} className="hover:bg-slate-100 text-nowrap">
                        ...
                        <td className="relative border-b border-slate-200 p-3">
                          <button
                            type="button"
                            className="py-0.5 px-3 focus:outline-none bg-white rounded border border-yaya-200 hover:bg-slate-200 hover:text-gray-700 focus:z-10 focus:ring-4 focus:ring-slate-200"
                          >
