...
const CreateTransaction = () => {
  ...
  return (
    <div className="page-container">
      ...
      <form
        className="max-w-[var(--form-width-small)] border p-8 pt-6 rounded-xl mx-auto mb-20"
      ...
      >
        ...
        <button
          ...
          className="mt-6 text-white bg-violet-700 hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-violet-300 font-medium rounded-lg text-sm w-full sm:w-[200px] px-5 py-2.5 text-center"
        >
