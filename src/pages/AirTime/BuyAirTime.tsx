    ...
    <div className="border rounded-lg p-5">
      ...
      >
        {definedAmounts.map((amount) => (
          <div
            key={amount}
            className={`flex justify-center items-center border border-yaya-200 hover:bg-yaya-50 rounded p-2 py-5 cursor-pointer ${selectedAmount === amount ? 'ring-4 ring-yaya-300' : ''}`}
            onClick={() => {
      ...
      <div className="">
        ...
        <div className="relative max-w-lg">
          ...
          <input
            ...
            step="1"
            id="amount"
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yaya-500 focus:border-yaya-500 block w-full ps-12 p-2.5 outline-none"
      ...
      <button
        className="block mx-auto mt-10 text-white gap-x-2 bg-yaya-600 hover:bg-yaya-700 focus:ring-4 focus:outline-none focus:ring-yaya-300 font-medium rounded-lg w-full sm:max-w-56 px-5 py-2 text-center"
